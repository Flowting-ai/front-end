...
export const PERSONA_SHARE_DETAIL_ENDPOINT = (id: string) =>
  withBase(`/persona-shares/${id}`)
export const PERSONA_SHARE_ACCEPT_ENDPOINT = (id: string) =>
  withBase(`/persona-shares/${id}/accept`)
