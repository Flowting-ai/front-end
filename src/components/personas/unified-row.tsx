...
//
// Key Principles:
// 1. All columns use flex-shrink-0 to prevent compression and overlapping
...
//
const COLUMN_WIDTHS = {
  spacer: "w-2 md:w-2.5 lg:w-3",
  main: "w-[140px] sm:w-[160px] md:w-[170px] lg:w-[180px] xl:w-[190px]",
  tokens: "w-[70px] sm:w-[80px] md:w-[100px] lg:w-[110px]",
  middle: "w-[90px] sm:w-[100px] md:w-[130px] lg:w-[150px] xl:w-[180px]",
  status: "w-[75px] sm:w-[85px] md:w-[95px] lg:w-[100px]",
  lastActivity: "w-[80px] sm:w-[100px] md:w-[120px] lg:w-[130px]",
  actions: "w-[80px] sm:w-[90px] md:w-[100px] lg:w-[110px]",
      ...
      >
        ...
        >
          <div className="flex w-full items-center h-full overflow-x-auto">
            {/* Spacer */}
            <div className={cn(COLUMN_WIDTHS.spacer, "flex-shrink-0")}></div>
              ...
              {isPersona && personaProps && (
                <>
                  <Button
                    ...
                    className="h-7 w-7 flex-shrink-0 p-0 text-[var(--colors-gray-600,#4b5563)] hover:bg-transparent hover:text-black"
                  ...
                  <Avatar className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 flex-shrink-0 border border-[var(--general-border,#e5e5e5)]" style={{ opacity: 1 }}>
              ...
              {isConsumer && consumerProps && (
                <>
                  <Checkbox
                    ...
                    className="h-[14px] w-[14px] flex-shrink-0 rounded-[4px] border border-[#D4D4D4] data-[state=checked]:border-[#6366F1] data-[state=checked]:bg-[#6366F1]"
                    style={{ 
                      opacity: 1, 
                      top: '1px', 
                      left: '1px',
                  ...
                  />
                  <Avatar className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 flex-shrink-0 border border-[var(--general-border,#e5e5e5)]">
            ...
            <div className={cn(
              ...
              "flex items-center justify-center text-center flex-shrink-0",
              isPersona ? "h-[55px]" : "h-[48px]"
            )}>
              {isPersona ? (
            ...
            <div className={cn(
              ...
              <span className={cn(
                "text-[var(--colors-gray-500,#6b7280)] truncate px-1",
              ...
              {isPersona && (
                <>
                  <Button
                    ...
                    className="h-7 w-7 sm:h-8 sm:w-8 md:h-9 md:w-9 flex-shrink-0 rounded-full bg-[var(--general-secondary,#F5F5F5)] text-[#111827] hover:bg-[#E5E7EB] hover:text-black"
                  >
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        size="sm"
                        className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 flex-shrink-0 rounded-full border border-[var(--general-border,#e5e5e5)] p-0 text-[var(--colors-gray-600,#4b5563)] hover:text-black"
                      >
                      ...
                      <DropdownMenuContent align="end" className="w-[160px] sm:w-[180px] md:w-[196px] rounded-[8px] bg-white p-1 border-0 shadow-lg">
                        ...
                        >
                          <FilePenLine className="h-3.5 w-3.5 md:h-4 md:w-4 ml-2 flex-shrink-0" />
                        ...
                        {status === "active" ? (
                          <DropdownMenuItem 
                            ...
                            className="h-8 min-h-[32px] gap-2 rounded-[6px] px-0.5 py-[5.5px] text-[11px] sm:text-[12px] md:text-[13px] text-[#111827] hover:bg-[#E5E5E5] hover:text-black focus:bg-[#E5E5E5] focus:text-black cursor-pointer"
                          >
                            <Pause className="h-3.5 w-3.5 md:h-4 md:w-4 ml-2 flex-shrink-0" />
                            Pause
                          </DropdownMenuItem>
                        ) : (
                          <DropdownMenuItem 
                            ...
                            className="h-8 min-h-[32px] gap-2 rounded-[6px] px-0.5 py-[5.5px] text-[11px] sm:text-[12px] md:text-[13px] text-[#111827] hover:bg-[#E5E5E5] hover:text-black focus:bg-[#E5E5E5] focus:text-black cursor-pointer"
                          >
                            <Play className="h-3.5 w-3.5 md:h-4 md:w-4 ml-2 flex-shrink-0" />
                            Resume
                          </DropdownMenuItem>
                        )}
                        <DropdownMenuItem 
                          ...
                          className="h-8 min-h-[32px] gap-2 rounded-[6px] px-0.5 py-[5.5px] text-[11px] sm:text-[12px] md:text-[13px] text-[#111827] hover:bg-[#E5E5E5] hover:text-black focus:bg-[#E5E5E5] focus:text-black cursor-pointer"
                        >
                          <Trash2 className="h-3.5 w-3.5 md:h-4 md:w-4 ml-2 flex-shrink-0" />
                          Delete
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
