    ...
    <section className="w-full min-h-screen">
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-4 px-4 lg:px-0">
        ...
        <div className="flex flex-col gap-3 lg:gap-2">
          ...
          <h1 className="font-medium lg:font-normal leading-[120%] text-xl lg:text-[37px] text-black">
          ...
          <div className="z-0 absolute inset-0 overflow-hidden rounded-2xl lg:rounded-3xl flex items-center justify-center">
            ...
            <div className="z-3 absolute top-2 lg:top-30.5 w-[95%] xl:w-252 xl:h-234 bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="relative w-full h-full flex">
                {/* Left Sidebar */}
                <div className="hidden w-16 h-full bg-main-bg border-r border-main-border lg:flex flex-col px-3">
                  {/* Logo */}
                  <div className="w-full h-auto min-h-14 border-b border-main-border flex items-center justify-center">
                    <Image
                  ...
                  <div className="w-full h-full flex flex-col items-center gap-3 mt-5">
                    <button className="w-10 h-10 bg-white border border-zinc-600 rounded-[18px] flex items-center justify-center">
                      <Image
                    ...
                    <button className="w-10 h-10 bg-white border border-main-border rounded-[18px] flex items-center justify-center">
                ...
                <div className="flex-1 flex flex-col">
                  {/* Topbar */}
                  <div className="w-full h-14 border-b border-main-border flex items-center px-4">
                    <button className="animate-dual-beam animate-border-rotate bg-main-bg border-2! border-main-border rounded-lg shadow-sm flex items-center gap-2 px-3 py-1.5">
                      <Image
                  ...
                  <div className="flex-1 flex">
                    ...
                    <div className="flex-1 flex flex-col gap-4 my-6">
                      <div className="w-full h-auto flex items-center justify-end px-2 lg:px-6">
                        <p className="w-full lg:max-w-1/2 text-xs lg:text-sm border border-main-border rounded-tr-sm rounded-tl-2xl rounded-b-2xl px-4 py-2">
                      ...
                      <div className="w-full h-auto flex flex-row lg:flex-row items-start justify-start gap-0 px-2 lg:px-6">
                        ...
                        >
                          ...
                          <div
                            ref={line4Ref}
                            className="w-auto h-10 tracking-normal text-black border border-main-border rounded-tl-sm rounded-tr-2xl rounded-b-2xl flex items-center px-4 opacity-0"
                          >
                    ...
                    {/* Right Sidebar */}
                    <div className="hidden w-16 h-full border-l border-main-border lg:flex flex-col px-1">
                      {/* Icons */}
                      <div className="w-full h-full flex flex-col items-center gap-3 mt-3">
                        <button className="w-full h-16 bg-transparent border-0 border-main-border rounded-xl flex flex-col items-center justify-center gap-1">
                          <Pin size={24} strokeWidth={1.4} />
                          <p className="font-semibold text-[10px] leading-[120%]">
                            Pin
                          </p>
                        </button>
                        <button className="w-full h-16 bg-transparent border-0 border-main-border rounded-xl flex flex-col items-center justify-center gap-1">
