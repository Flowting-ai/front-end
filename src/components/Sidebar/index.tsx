...
// Hugeicons' free package doesn't ship brand glyphs, so the stroke-rounded paths
// are inlined here and recoloured via currentColor to match the sibling icons.
