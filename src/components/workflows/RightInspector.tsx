...
export default function RightInspector({
  ...
  return (
    <div className="absolute top-14 right-2 w-80 h-[calc(100vh-104px)] bg-white border border-[#E5E5E5] rounded-[16px] shadow-lg overflow-hidden z-40">
      {/* Header */}
      ...
      {/* Content */}
      <div className={`shadow-b p-4 space-y-6 max-h-[calc(100vh-170px)] overflow-y-auto ${chatStyles.customScrollbar}`}>
        {/* Node Type Badge */}
