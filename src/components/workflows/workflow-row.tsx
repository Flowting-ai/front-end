...
import { ChevronDown, ChevronRight, FilePenLine, MoreVertical, Pause, Play, Trash2, Workflow, MessageSquare } from "lucide-react";
...
export const WorkflowRow = React.forwardRef<HTMLTableRowElement, WorkflowRowProps>(
  (
    {
      workflow,
      onPause,
