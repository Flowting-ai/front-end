...
import { normalizePct, formatDate } from "@/lib/utils/format-utils";
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      toast.success("Subscription canceled", {
        description: `Your plan will remain active until ${formatDate(user?.currentPeriodEnd, { fallback: "-", year: true })}.`,
      });
      await refreshUser();
    } catch (err) {
          ...
          <DialogHeader>
            ...
            <DialogDescription className="text-[#6B7280]">
              ...
              <span className="font-medium text-[#171717]">
                {formatDate(user?.currentPeriodEnd, { fallback: "-", year: true })}
              </span>
            ...
            <div className="flex items-start gap-3 rounded-[8px] border border-[#FCD34D] bg-[#FFFBEB] px-4 py-3 text-[#92400E]">
              ...
              <div>
                ...
                <p className="text-xs mt-0.5">
                  ...
                  <span className="font-medium">{formatDate(user?.currentPeriodEnd, { fallback: "-", year: true })}</span>.
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-sm text-[#B3B3B3]">
                  {hasActiveSubscription
                    ? `Status: ${subscriptionStatus}${cancelAtPeriodEnd ? " (cancels at period end)" : ""} • Next billing: ${formatDate(nextBillingDate, { fallback: "-", year: true })}`
              ...
              <div className="text-[#171717] bg-[#FAFAFA] border border-[#E5E7EB] rounded-[8px] flex justify-between px-4 py-3">
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-[#6B7280]">
                    {formatDate(upcomingInvoice.next_payment_date, { fallback: "-", year: true })}
                  </p>
                </div>
            ...
            return (
              <div className="flex items-center gap-4 mb-4">
                <div className="w-36 shrink-0">
                  ...
                  <p className="text-xs text-[#757575]">Last reset {formatDate(user?.usage?.last_reset_date, { fallback: "-", year: true })}</p>
                </div>
                      ...
                      invoices.map((invoice) => (
                        ...
                        >
                          <td className="px-4 py-2">
                            ...
                            {formatDate(invoice.created, { fallback: "-", year: true })}
                          </td>
                          <td className="px-4 py-2">
