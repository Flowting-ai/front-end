...
// Team name flexes (avatar + name + description need the room); the rest are
// short badges/pills that stay fixed. Unlike the sibling tables on this page
// family (members/activity/analytics all mix in a `minmax()`/`fr` track),
// this used to be six fixed-px columns summing to 1066px — wider than the
// settings shell's available width below ~1466px viewports, forcing the
// whole table to overflow horizontally on ordinary laptop screens.
...
export default function OrgTeamsPage() {
  ...
  // sync with /connectors' Team access tab and /org/team/[teamId], which
