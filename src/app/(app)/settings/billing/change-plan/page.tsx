...
const TEAM_PLANS: { price: number; credits: number; label: string }[] = [
  { price: 125,  credits: 60000,   label: '$125' },
  { price: 250,  credits: 120000,  label: '$250' },
  { price: 500,  credits: 250000,  label: '$500' },
  { price: 1000, credits: 500000,  label: '$1k'  },
  { price: 1500, credits: 750000,  label: '$1.5k'},
  { price: 2000, credits: 1000000, label: '$2k'  },
]
...
export default function ChangePlanPage() {
  ...
  const [changingTo,    setChangingTo]    = useState<UserPlanType | null>(null)
  ...
  const handleSelectIndividual = async () => {
    ...
    setChangingTo(plan)
    try {
      const checkout = await createCheckoutSession(plan, 'monthly')
  ...
  const handleStartTeam = () => {
    toast.info('Contact contact@getsouvenir.com to set up or upgrade your team plan.')
  }
