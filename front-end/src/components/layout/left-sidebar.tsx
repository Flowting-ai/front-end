              ...
              {isChatBoardsExpanded && (
                <>
                  ...
                  {boardsToDisplay.length > 0 ? (
                    <div id="recent-chat-boards" className="mt-4 flex-1 min-h-0 space-y-2 overflow-y-auto scrollbar-hidden snap-y snap-mandatory max-h-[548px] transition-all duration-500">
