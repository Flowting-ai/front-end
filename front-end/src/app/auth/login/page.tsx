...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-[#F5F5F5] flex items-center justify-center">
      ...
      {/* Right */}
      <div className="w-1/2 h-full flex items-center justify-center">
        <div className="min-w-[320px] w-[625px] min-h-[472px] bg-white border border-main-border rounded-lg flex flex-col gap-6 px-6 pt-6">
          {/* Header */}
          ...
          <form className="flex flex-col flex-1 gap-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center gap-6">
              ...
              <Button
                type="submit"
                className="cursor-pointer min-w-[70px] w-auto h-[40px] font-inter font-normal text-[16px] text-[#F5F5F5] bg-[#2C2C2C] hover:bg-[#0F0F0F] rounded-[8px] transition-all duration-300"
